...
import { deleteTransaction, updateTransaction } from "../../../services/Transaction/TransactionService";
...
const AllTransactionTable: React.FC<ITransactionTable> = () => {
  ...
  const [transactions, setTransactions] = useState<Transaction[]>([]);
    ...
    const fetchTransactions = async () => {
      try {
        const transactionsData = await getAllTransactionsByUser();
