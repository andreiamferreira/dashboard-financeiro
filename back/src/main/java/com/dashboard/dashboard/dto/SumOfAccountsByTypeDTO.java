...
public class SumOfAccountsByTypeDTO {

    private List<BankAccountDTO> accounts;
    private BigDecimal totalBalance;
    private Integer numberOfAccounts;

    public SumOfAccountsByTypeDTO() {
    }

    public SumOfAccountsByTypeDTO(List<BankAccountDTO> accounts, BigDecimal totalBalance, Integer numberOfAccounts) {
